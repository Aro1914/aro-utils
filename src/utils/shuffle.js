/**
 * Shuffles an array randomly and optionally returns a subset of it.
 *
 * This function uses the Fisher-Yates algorithm to shuffle the input array.
 * If a return amount is specified, it returns that number of elements from
 * the shuffled array. If the return amount is greater than the array length,
 * the entire shuffled array is returned.
 *
 * @param {Array} array - The array to shuffle.
 * @param {number} [returnAmount] - Optional number of elements to return from
 *   the shuffled array.
 * @returns {Array} A new array containing the shuffled elements or a subset
 *   of them if a return amount is specified.
 */
